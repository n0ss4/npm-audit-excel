...
import { t } from '../i18n';
import type { AuditReport, ProcessedVulnerability } from '../types';
...
export class ExcelReportGenerator {
  ...
  private createDataMapping(vuln: ProcessedVulnerability): Record<string, unknown> {
  ...
  private createRowData(dataMapping: Record<string, unknown>): unknown[] {
